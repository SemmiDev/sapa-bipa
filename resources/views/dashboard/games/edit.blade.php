...
@section('content')
    <div class="container mx-auto p-4 font-nunito">
        <div class="bg-white shadow-lg rounded-lg">
            ...
            <div class="p-6">
                <form action="{{ route('dashboard.games.update', $game) }}" method="POST" enctype="multipart/form-data" id="gameForm">
                    @csrf
                    @method('PUT')
                    <div class="space-y-6">
                        <div>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="editor" hidden>{{ old('description', $game->description) }}</textarea>
                            @error('description')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            ...
                            @error('code')
                                <p class="mt-2 text-sm text-red-green-600">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
