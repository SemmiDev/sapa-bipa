    ...
    <div class="bg-white shadow-lg rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">Kelola kategori untuk artikel Anda.</p>
            </div>
            <a href="{{ route('dashboard.articles-categories.create') }}"
                        ...
                        @foreach ($categories as $category)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="{{ route('dashboard.articles-categories.show', $category) }}"
                                    ...
                                    <a href="{{ route('dashboard.articles-categories.edit', $category) }}"
                                ...
                                <div class="relative p-4 w-full max-w-md max-h-full">
                                    <div class="relative bg-white rounded-lg shadow">
                                        <div class="p-4 text-center">
                                            ...
                                            <form action="{{ route('dashboard.articles-categories.destroy', $category) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
