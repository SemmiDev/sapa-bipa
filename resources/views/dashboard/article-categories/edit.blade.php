...
<div class="container mx-auto p-4 font-nunito">
    <div class="bg-white shadow-lg rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Edit Kategori Artikel</h2>
            <p class="text-sm text-gray-600 mt-1">Perbarui informasi kategori artikel.</p>
        </div>

        <div class="p-6">
            <form action="{{ route('dashboard.articles-categories.update', $articleCategory) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="space-y-6">
                    <div>
