...
<div class="container mx-auto p-4 font-nunito">
    <div class="bg-white shadow-lg rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Detail Artikel</h2>
            <p class="text-sm text-gray-600 mt-1">Informasi tentang artikel.</p>
        </div>
        ...
        <div class="p-6">
            <div class="space-y-4">
                <div>
                    ...
                    <p class="mt-1 text-gray-900">{{ $article->title }}</p>
                </div>
                <div>
                    <h3 class="text-sm font-medium text-gray-700">Kategori</h3>
                    <p class="mt-1 text-gray-900">{{ $article->articleCategory->name }}</p>
                </div>
                <div>
