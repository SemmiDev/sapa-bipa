...
@section('title', 'Detail Kategori Kosa Kata')

@section('content')
<div class="container mx-auto p-4 font-nunito">
    <div class="bg-white shadow-lg rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-800">Detail Kategori Kosa Kata</h2>
            <p class="text-sm text-gray-600 mt-1">Informasi tentang kategori kosa kata.</p>
        </div>
        ...
        <div class="p-6">
            <div class="space-y-4">
                <div>
                    ...
                    <p class="mt-1 text-gray-900">{{ $vocabularyCategory->name }}</p>
                </div>
                <div>
