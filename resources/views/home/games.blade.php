                        ...
                        <a href="/games/{{ $game->id }}/show"
                           ...
                           class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 cursor-pointer">
                            <div class="h-40">
                                ...
                                @else
                                    <div class="h-full bg-gradient-to-r from-teal-600 to-orange-400 flex items-center justify-center">
                            ...
                            <div class="p-6">
                                ...
                                <button class="w-full bg-gradient-to-r from-teal-600 to-orange-400 text-white py-2 rounded-lg font-medium hover:shadow-lg transition-all duration-300">
                                    Mainkan Sekarang
                                </button>
                            </div>
                        </a>
